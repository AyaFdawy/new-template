...
{/* <div className={styles.formcontentright}>
      ...
      <form onSubmit={handleSubmitlogin} noValidate>
        ...
        <Row className="login mt-md-5" style={{paddingTop:"0px"}}>
        <div className='nav active'style={{backgroundColor:"#fff",margin:"0",borderRadius:"0",boxShadow:"none",float:'right'}}>
           <Link to="/" className="logo1" style={{float:'left'}}>
                {/* <img src={logo} alt='' /> */}
                <div className="logo2"style={{height:"55px",float:'left'}}>
                ma<p>T </p> es
              </div>
            </Link> 
