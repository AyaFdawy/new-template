...
const Teams = (props) => {
  ...
  const inviteUser = (teamnum, email) => {

    console.log(teamnum)
    let item = email
    fetch(`https://boiling-shelf-43809.herokuapp.com/team/${teamnum}/invite`,
      {
        method: "POST",
        headers: {
          'Accept': 'application/json',
...
<Dropdown.Item style={{color:"green",padding:"10px" ,margin:"5px",fontSize:"large"  }} className="fas fa-eye" onClick={() =>viewMembers(obj._id)  } >  View Members</Dropdown.Item>
<Dropdown.Item style={{color:"black", padding:"10px" ,margin:"5px",fontSize:"large" }} className="fas fa-user-plus mr-5" onClick={() => handleShow3()}>  Ivite Member</Dropdown.Item>
